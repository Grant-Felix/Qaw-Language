...
| 2 | 代码式语言（**Qaw 本身**） | `.qaw` 纯文本；**Qaw 生态**可以基于 Qaw 做可视化/低代码工具（类似 Python + Jupyter） |
...
详细任务清单见 [`docs/v0.10-to-v0.50-规划.md`](docs/v0.10-to-v0.50-规划.md)（基于 16 种主流语言研究的 64 项任务）。
...
| 4 | [`docs/v0.10-to-v0.50-规划.md`](docs/v0.10-to-v0.50-规划.md) | v0.10 → v0.50 详细任务清单（基于语言研究） |
...
设计     解释器+6 示例 C 后端占位  LLVM 后端     自举          WASM
         Hello World    (回退到 run)

> v0.5/v0.9/v1.0/v2.0 是历史阶段标签；新规划按 v0.50/v0.100/v0.150/v0.200/v0.260/v1.0 里程碑驱动（见 [docs/book/21-路线图与风险.md](docs/book/21-路线图与风险.md) §21.2）
